...
<script lang="ts">
    ...
    @Component
    export default class ContentPlaceholders extends Vue {
...
<style lang="scss">
    ...
    $vue-content-placeholders-line-height: 35px !default;
    $vue-content-placeholders-spacing: 20px !default;
